...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update user data locally (in a real app, you would update the backend)
      setUser({
        ...user,
        ...formData
      });
                ...
                <div>
                  ...
                  {user.city_state && (
                    <div className="flex items-center mt-1 text-blue-100">
                      ...
                      <p>{user.city_state}{user.country ? `, ${user.country}` : ''}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="border-b border-gray-200">
            <nav className="flex">
              <button
                ...
                className={`px-6 py-4 text-sm font-medium ${activeTab === 'personal' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'} focus:outline-none`}
              >
                Personal Info
              </button>
              <button
                onClick={() => setActiveTab('social')} 
                className={`px-6 py-4 text-sm font-medium ${activeTab === 'social' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'} focus:outline-none`}
              >
                Social Links
              </button>
            </nav>
                    ...
                    {(user.facebook || user.instagram || user.linkedin || user.twitter) ? (
                      <div className="bg-gray-50 rounded-lg p-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          {user.facebook && (
                            <a href={`https://facebook.com/${user.facebook}`} target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition">
                          ...
                          {user.instagram && (
                            <a href={`https://instagram.com/${user.instagram}`} target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition">
                          ...
                          {user.linkedin && (
                            <a href={`https://linkedin.com/in/${user.linkedin}`} target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition">
                          ...
                          {user.twitter && (
                            <a href={`https://twitter.com/${user.twitter}`} target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition">
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 text-center">
                        <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L20 16m-16-7l4.586 4.586a2 2 0 002.828 0L20 9" />
                        </svg>
                        <h3 className="mt-2 text-sm font-medium text-gray-900">No social links added yet</h3>
                        <p className="mt-1 text-sm text-gray-500">Add your social media profiles to connect with others</p>
                      </div>
                    )}
                  </div>
                )}
